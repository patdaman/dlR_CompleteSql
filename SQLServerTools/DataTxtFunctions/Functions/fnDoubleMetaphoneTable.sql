...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			-- This call to fnStringAt() is the 'worst case' in number of values passed. 
			--	A UDF that used DEFAULT values instead of
            -- a multi-valued argument would require ten DEFAULT arguments for EP, EB, EL, 
			--	etc. (assuming the first was not defined with a DEFAULT).
	                ELSE IF ((@CurrentPosition = 1)
